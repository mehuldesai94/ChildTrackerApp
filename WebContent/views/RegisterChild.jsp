...
<body>
	...
	<div class="container register">
		<h3 style="text-align: center">Register Child</h3>
		<form method="post" action="../ProcessRegisterChild">
			<div class="row">
				<div class="col-md-6">
					<div>
				...
				<div class="col-md-6">
					<div>
						Phone* <input type="tel" class="form-control"
							 name="phone">
					</div>
					<div>
					...
					<div>
						Date of Birth* <input type="date" class="form-control"
							placeholder="YYYY-MM-DD" value="" name="birthdate" />
					</div>
